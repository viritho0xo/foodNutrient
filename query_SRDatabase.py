...
# for food in rawFoodDry:
#     out = fetch_food_details(food)
#     with open('FoodNutrients/rawFoodDryNutri.txt', 'a', encoding="utf-8") as f:
#         f.writelines(out + "\n")


# for food in rawFoodWet:
#     out = fetch_food_details(food)
#     with open('FoodNutrients/rawFoodWetNutri.txt', 'a', encoding="utf-8") as f:
#         f.writelines(out + "\n")
